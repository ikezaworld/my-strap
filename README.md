<img src="./docs/img/icon128.png" width="100px" align="left">  
...
<img src="./docs/img/description_chrome.png" width="800px" align="left">

### ChromeヘッダーにMy Strapアイコンをピン留め

<img src="./docs/img/description_header_icon.png" width="600px" align="left">

### My Strap設定ポップアップ

<img src="./docs/img/description_popup.png" width="400px" align="left">
...
5. ショートカットキーは以下2つから選択できる。
   ...
   - 任意のキーを手動設定
     ...
     - <img src="./docs/img/hand_shortcut.png" width="400px" align="left">
6. 設定が終わったら保存ボタンを押す、
